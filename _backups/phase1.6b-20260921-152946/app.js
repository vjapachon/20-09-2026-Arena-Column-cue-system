...
function renderTimeline() {
  try {
    ...
    visibleCues.forEach((cue, idx) => {
      ...
      // ═══ DURÉE INTELLIGENTE ═══
      // La cue suivante (dans l'ordre chronologique)
      ...
      if (nextCue) {
        ...
        // Dernière cue : finit à start + duration
      ...
      // ─── Contenu adaptatif ───
      // Largeur < 140px → tout en 1 ligne condensée
      // Largeur >= 140px → 2 lignes

      if (width < 140) {
        // Mode condensé : "Page 1 • 09:00 • Col 1"
